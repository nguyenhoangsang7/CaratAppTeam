...
public abstract class AppDatabase extends RoomDatabase {
    ...
    //Các abstract method trả về DAO
    ...
    public static synchronized AppDatabase getInstance(Context context) {
        if (instance == null) {//Đảm bảo trong app có duy nhất 1 database
            instance = Room.databaseBuilder(//database bằng Room.databaseBuilder
                            context.getApplicationContext(),
                            AppDatabase.class,
                            DATABASE_NAME
                    )
                    .addCallback(new Callback() {
                        @Override//Được gọi khi database được tạo lần đầu tiên (chưa có file DB trước đó).
                        ...
                        @Override//Được gọi mỗi khi database được mở
                        ...
                        private void seedDatabase() {   // hàm thêm các dữ liệu mẫu mặc định vào database
                            CategoryDao categoryDao = instance.categoryDao();
