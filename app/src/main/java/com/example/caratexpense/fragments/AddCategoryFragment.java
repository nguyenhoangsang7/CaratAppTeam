...
public class AddCategoryFragment extends BaseFragment {
    //Các thành phần UI và biến dữ liệu
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {//Nếu fragment được khởi tạo với tham số isExpense, sẽ lấy giá trị đó để chọn radio button mặc định (chi tiêu hoặc thu nhập).
        ...
        ivBack.setOnClickListener(v -> {//Khi nhấn nút back, chuyển về màn hình thêm giao dịch (AddTransactionFragment).
