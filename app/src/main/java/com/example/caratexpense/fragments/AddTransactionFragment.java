...
public class AddTransactionFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // Thiết lập menu nhấp để mở ngăn kéo
        ...
        // Kiểm tra xem chúng ta có đang chỉnh sửa một giao dịch hiện có không
    ...
    private void setupEditMode() {
        // Đặt giá trị từ giao dịch đang được chỉnh sửa
        ...
        // Đặt số tiền mà không cần định dạng
    ...
    private void loadCategories() {
        new Thread(() -> {
            ...
            requireActivity().runOnUiThread(() -> {
                ...
                // Nếu chỉnh sửa, hãy chọn danh mục
